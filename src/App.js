...
import ToolEdit from './ToolViews/ToolEdit.js';
...
const App = () => {
  const [tool, setTool] = useState( { id: "", userId: "", toolName: "", deposit: "", price: "", description: "", imageUrl: "",isRented: ""});
  ...
  <section className="nav">
    ...
    <section className="links">
      ...
      <Route path="/edit/:id" render={(props) => <ToolEdit {...props} tool={tool} setTool={setTool}/>} />
